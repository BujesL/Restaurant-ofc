		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">CONSULTA COZINHEIRO</h1>						
					</div>
					<div class="row">
					...
					<div class="row">
						<?php
							...
							if(isset($_SESSION['cozinheiro'])){
								...
								echo "<tr><th>#</th><th>NOME</th><th>CPF</th><th>ENDEREÇO</th><th>COZINHA</th></tr>";
								foreach($_SESSION['cozinheiro'] as $i=>$cozinheiro){
									
									$cpf = $cozinheiro->getCpf();
									$nome = $cozinheiro->getNome();
                                    $cozinha = $cozinheiro->getCozinha();
									$telefone = $cozinheiro->getTelefone();
                                        ...
                                        <input type='hidden' name='telefone' value='$telefone'>
                                         <input type='hidden' name='cozinha' value='$cozinha'>    
