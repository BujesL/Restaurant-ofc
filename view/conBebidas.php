		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">CONSULTA BEBIDAS</h1>						
					</div>
					<div class="row">
					...
					<div class="row">
						<?php
							...
							if(isset($_SESSION['bebidas'])){
								...
								echo "<tr><th>#</th><th>NOME</th><th>SABOR</th><th>TIPO</th></tr>";
								foreach($_SESSION['bebidas'] as $i=>$bebidas){
									
									$sabor = $bebidas->getSabor();
									$nome = $bebidas->getNome();
                                    $tipo = $bebidas->getTipo();
