		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">CONSULTA SOBREMESAS</h1>						
					</div>
					<div class="row">
					...
					<div class="row">
						<?php
							...
							if(isset($_SESSION['sobremesa'])){
								echo "<table class='table'>";
								echo "<tr><th>#</th><th>NOME</th><th>SABOR</th><th>TEMPERATURA</th></tr>";
								foreach($_SESSION['sobremesa'] as $i=>$sobremesa){
									
									$opcao = $sobremesa->getOpcao();
									$nome = $sobremesa->getNome();
                                    $temperatura = $sobremesa->getTemperatura();
