		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">CONSULTAR PEDIDO</h1>						
					</div>
					<div class="row">
					...
					<div class="row">
						<?php
							...
							if(isset($_SESSION['pedido'])){
								...
								echo "<tr><th>#</th><th>NOME</th><th>DESCRIÇAO</th><th>BEBIDA</th><th>CLIENTE</th></tr>";
								foreach($_SESSION['pedido'] as $i=>$pedido){
