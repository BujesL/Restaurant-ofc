		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">CADASTRO DA LIMPEZA</h1>						
					</div>
					<form action="../controller/registrarLimpeza.php" method="GET">
					<div class="row">
                            ...
                            <div class="col-12 col-lg-4">
								<div class="card">
									...
									<div class="card-body" >
                                        ...
                                        <input style= "margin-top:3%;" type="checkbox" name="local"class="form-control" value="COZINHA">SÓ A COZINHA<br>  
                                        <input style= "margin-top:3%;" type="checkbox" name="local"class="form-control" value="TODO RESTAURANTE">TODO RESTAURANTE. <br>
									</div>
								</div>						
							</div>
                            <div class="col-12 col-lg-4">
