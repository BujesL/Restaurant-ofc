		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">CADASTRO DO COZINHEIRO</h1>						
					</div>
					<form action="../controller/registrarCozinheiro.php" method="GET">
					<div class="row">
                            ...
                            <div class="col-12 col-lg-4">
								<div class="card">
									<div class="card-header">
										<h5 class="card-title mb-0">COZINHA:</h5>
									</div>
									<div class="card-body" >
										
                                        <input style= "margin-top:3%;" type="checkbox" name="cozinha"class="form-control" value="COMIDAS">COMIDAS<br>  
                                        <input style= "margin-top:3%;" type="checkbox" name="cozinha"class="form-control" value="SOBREMESAS">SOBREMESAS<br>
									</div>
								</div>						
							</div>
                            <div class="col-12 col-lg-4">
