		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">CONSULTA LIMPEZA</h1>						
					</div>
					<div class="row">
					...
					<div class="row">
						<?php
							...
							if(isset($_SESSION['limpeza'])){
								echo "<table class='table'>";
								echo "<tr><th>#</th><th>NOME</th><th>CPF</th><th>ENDEREÇO</th><th>LOCAL</th></tr>";
								foreach($_SESSION['limpeza'] as $i=>$limpeza){
									
									$cpf = $limpeza->getCpf();
									$nome = $limpeza->getNome();
                                    $local = $limpeza->getLocal();
