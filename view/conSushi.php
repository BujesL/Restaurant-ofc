		...
		<nav class="navbar navbar-expand navbar-light navbar-bg">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="mb-3">
						<h1 class="h3 d-inline align-middle">CONSULTA SUSHI</h1>						
					</div>
					<div class="row">
					...
					<div class="row">
						<?php
							...
							if(isset($_SESSION['sushi'])){
								...
								echo "<tr><th>#</th><th>NOME</th><th>MOLHO</th><th>MODO</th></tr>";
								foreach($_SESSION['sushi'] as $i=>$sushi){
									
									$molho = $sushi->getMolho();
									$nome = $sushi->getNome();
                                    $modo = $sushi->getModo();
                                        ...
                                        <input type='hidden' name='molho' value='$molho'>
